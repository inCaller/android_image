...
echo y|android update sdk --no-ui --all --filter platform-tools,extra-android-support,tools,build-tools-25.0.2,build-tools-24.0.3,android-24,android-25,android-19,extra,sys-img-armeabi-v7a-android-19
